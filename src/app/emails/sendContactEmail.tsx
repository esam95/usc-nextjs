...
export default function ContactEmail({ name, emailAddress, message }: EmailProps) {
  return (
    <Html>
      <Head />
      <Tailwind>
        <Preview>Nytt kontaktmeddelande</Preview>
        <Body className='bg-background text-foreground font-sans'>
          <Container className='max-w-[580px] mx-auto my-8 bg-card text-card-foreground shadow-lg rounded-lg'>
            ...
            <Section className='p-5 px-8'>
              <Text className='leading-6 text-xl font-semibold mb-4 text-primary'>Nytt meddelande</Text>
              ...
              <Section className='bg-gray-100 p-4 rounded-lg shadow-xl'>
                ...
                <Text className='leading-6 text-base font-bold'>Meddelande:</Text>
                <Text className='leading-6 text-base mb-2'>{message}</Text>
              </Section>
